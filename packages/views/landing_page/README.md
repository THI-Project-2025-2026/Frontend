...
3. Depend only on `flutter`, `flutter_bloc`, `core_ui`, `l10n_service`, and reusable `features/*` packages; never import another view package directly.
